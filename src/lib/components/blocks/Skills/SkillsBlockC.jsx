...
const SkillsBlockC = ({ heading, body, marginTop }) => {
    return (
        <div style={{ marginTop: marginTop + 'px' }}>
            <HeadingC content={heading} actionCreator={(heading) => ({ entity: 'skill', action: 'updateSkillHeading', payload: heading })} />
...
export default skillBlockHoc(memo(SkillsBlockC));
