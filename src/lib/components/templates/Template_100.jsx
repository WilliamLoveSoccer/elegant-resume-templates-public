...
import Hero03 from '../blocks/Hero/Hero03';
...
const Template = (props) => {
    ...
    return (
        <PageContext.Provider value={{ topMargin, header_style, HeadingComponent: HeadingA }}>
            <div id="resumeMainSection">
                <div className="er-flex er-justify-start er-items-center er-pb-2">
                    <div className="er-mr-8">
                        <Photo />
                    </div>
                    <Hero03 />
                </div>
