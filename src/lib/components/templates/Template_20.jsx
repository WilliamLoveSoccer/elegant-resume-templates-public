...
const Template = (props) => {
    ...
    return (
        <PageContext.Provider value={{ header_style, heading: Hero02 }}>
            <div id="HeadingBlock">
                <Hero02 />
            </div>
            <div className="er-grid er-grid-cols-7 er-gap-7">
                <div className="er-col-span-5">
                    <div id="resumeMainSection">
                        <PageContext.Provider value={{ topMargin, header_style }}>
                            <DraggableBlocksB draggableBlocks={draggableBlocks[0]} availableBlocks={MainSectionBlocks} />
                ...
                <div className="er-col-span-2">
                    <div id="resumeSubSection">
                        ...
                        >
                            <DraggableBlocksB draggableBlocks={draggableBlocks[1]} availableBlocks={SubSectionBlocks} />
                        </PageContext.Provider>
                    </div>
                </div>
            </div>
